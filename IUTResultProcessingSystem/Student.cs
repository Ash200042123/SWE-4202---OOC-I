...
namespace IUTResultProcessingSystem
{
    public class Student
    {
        ...
        public int attendance, quiz1, quiz2, quiz3, quiz4, quizTotal, mid, final, viva, total;
        ...
        public void calculateQuizTotal()
        {
            ...
            {
                this.quizTotal = quiz2 + quiz3 + quiz4;
            }
            else if (quiz2 < quiz1 && quiz2 < quiz3 && quiz2 < quiz4)
            {
                this.quizTotal = quiz1 + quiz3 + quiz4;
            }
            else if (quiz3 < quiz1 && quiz3 < quiz2 && quiz1 < quiz4)
            {
                this.quizTotal = quiz2 + quiz1 + quiz4;
            }
            else if (quiz4 < quiz1 && quiz4 < quiz2 && quiz4 < quiz3)
            {
                this.quizTotal = quiz2 + quiz3 + quiz1;
            }
            else
            {
                this.quizTotal = quiz1 + quiz4 + quiz2;
            }
        }
        public void calculateTotal()
        {
            this.total = attendance + quizTotal + mid + final + viva;
        }
