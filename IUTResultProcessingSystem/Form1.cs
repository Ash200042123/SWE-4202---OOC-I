...
namespace IUTResultProcessingSystem
{
    public partial class Form1 : Form
    {
        ...
        {
            using (var reader = new StreamReader(@"C:\Users\ASUS\Desktop\C#\IUTResultProcessingSystem\SWE4201MarkSheet1.csv"))
            {
            ...
            var List = from student in studentList
                       select student;
            listBox1.Items.Add("Student ID" + "\t" + "Name");
            listBox2.Items.Add("Percentage" + "\t" + "Grade");
            foreach (var any in List)
            {
                listBox1.Items.Add(any.ID + "\t" + any.name);
                    listBox2.Items.Add(any.percentage +"%\t"+   any.grade.PadLeft(20));
            }
        ...
        var showList = from student in studentList
            ...
            foreach(Student student1 in showList)
            {
                ...
                quizTotalLabel.Text= Convert.ToString("Quiz Total(Best 3):\t" + student1.quizTotal);
