       ...
       public int checkIt()
        {
            ...
            else if(R1C1Button.BackColor!=Color.White && R1C2Button.BackColor != Color.White && R1C3Button.BackColor != Color.White
                && R2C1Button.BackColor != Color.White && R2C2Button.BackColor != Color.White && R2C3Button.BackColor != Color.White
                    && R3C1Button.BackColor != Color.White && R3C2Button.BackColor != Color.White && R3C3Button.BackColor != Color.White)
            {
                winner = 3;
            }
            return winner;
